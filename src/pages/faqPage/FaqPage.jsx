  ...
  return (
    <div className="pb-[64px]">
      ...
      <div className="flex flex-col justify-center items-center space-y-3">
        ...
        <h1 className="font-Poppins font-semibold text-[36px] text-[#172B4D]">Frequently asked questions</h1>
        <p className="font-Inter text-[20px] text-[#3E4F6B] pt-[12px] pb-[64px]">Common questions from people ask about our products and services.</p>
      </div>
