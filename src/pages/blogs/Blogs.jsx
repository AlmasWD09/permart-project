    ...
    <div className="pb-[64px]">
      <div>
        <div className="flex flex-col justify-center items-center space-y-3">
          ...
          <h1 className="font-Poppins font-semibold text-[36px] text-[#172B4D]">To get knowledge read our blogs</h1>
          <p className="font-Inter text-[20px] text-[#3E4F6B] pt-[12px] pb-[64px] max-w-[560px]">Helps you to keep update about your pet’s fitness.</p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="relative">
              ...
              <div className="absolute left-6 bottom-6 max-w-[353px]">
              <h1 className="font-Poppins font-semibold text-[30px] text-[#172B4D]">Why your pet become angry</h1>
            ...
            <div className="relative">
              ...
              <div className="absolute left-6 bottom-6 max-w-[353px]">
              <h1 className="font-Poppins font-semibold text-[30px] text-[#172B4D]">To know symptoms can enhance fitness</h1>
